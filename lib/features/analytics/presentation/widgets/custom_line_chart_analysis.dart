...
class CustomLineChartAnalysis extends StatefulWidget {
  final List data;
  const CustomLineChartAnalysis({
    super.key,
    required this.data,
  });

  @override
  State<CustomLineChartAnalysis> createState() => _CustomLineChartState();
}

class _CustomLineChartState extends State<CustomLineChartAnalysis> {
